...
#             # recent_messages = session.messages.order_by('-timestamp')[:6]
#             # chat_history = []
#             # for msg in reversed(recent_messages):
#             #     if msg.is_from_ai:
#             #         chat_history.append({"role": "ai", "content": msg.message})
#             #     else:
#             #         chat_history.append({"role": "human", "content": msg.message})
